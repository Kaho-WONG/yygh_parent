...
import com.kaho.yygh.hosp.repository.ScheduleRepository;
...
import com.kaho.yygh.model.hosp.BookingRule;
...
import com.kaho.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public Map<String, Object> getBookingScheduleRule(int page, int limit, String hoscode, String depcode) {
        ...
        baseMap.put("workDateString", new DateTime().toString("yyyy年MM月")); //年月
    ...
    private IPage getListDate(int page, int limit, BookingRule bookingRule) {
        ...
        for(int i = 0; i < cycle; i++) {
            DateTime curDateTime = new DateTime().plusDays(i); //plusDay即为往后推 i 天
    ...
    public ScheduleOrderVo getScheduleOrderVo(String scheduleId) {
        ...
        //获取排班信息
        Schedule schedule = this.getScheduleId(scheduleId); //从mongodb中查
        if(schedule == null) {
            throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        }
        //获取预约规则信息
        Hospital hospital = hospitalService.getByHoscode(schedule.getHoscode()); //从mongodb中查
        if(hospital == null) {
            throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        }
